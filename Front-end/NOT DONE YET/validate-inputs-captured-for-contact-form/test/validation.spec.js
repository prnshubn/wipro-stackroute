...
const submitContact = require("../js/script");
...
describe("Submit Validation", function () {
    ...
    it("should be a function", function () {
        expect(typeof (submitContact)).equal("function");
    });
    ...
    it('should display error message for empty FirstName', () => {
        ...
        expect(validationSummary).contain(`FirstName cannot be left blank`);
    });
    ...
    it('should display error message for invalid FirstName', () => {
        ...
        document.getElementsByTagName('input')[8].click();
        const validationSummary = document.getElementById('validationSummary').getElementsByTagName('ul')[0].innerHTML;
        expect(validationSummary).contain(`FirstName can contain only alphabets and (.)`);
    });

    it('should display error message for empty Email', () => {
        document.getElementsByTagName('input')[8].click();
        const validationSummary = document.getElementById('validationSummary').getElementsByTagName('ul')[0].innerHTML;
        expect(validationSummary).contain(`Email cannot be left blank`);
    });
    ...
    it('should display error message for invalid Email', () => {
        ...
        document.getElementsByTagName('input')[8].click();
        const validationSummary = document.getElementById('validationSummary').getElementsByTagName('ul')[0].innerHTML;
        expect(validationSummary).contain(`Invalid Email`);
    });

    it('should display error message for empty Home Contact Number', () => {
        document.getElementsByTagName('input')[8].click();
        const validationSummary = document.getElementById('validationSummary').getElementsByTagName('ul')[0].innerHTML;
        expect(validationSummary).contain(`Home No cannot be left blank`);
    });
    ...
    it('should display error message for invalid Home Contact Number', () => {
        ...
        document.getElementsByTagName('input')[8].click();
        const validationSummary = document.getElementById('validationSummary').getElementsByTagName('ul')[0].innerHTML;
        expect(validationSummary).contain(`Home Contact No should start with country code prefixed by + and followed by 10 digits`);
    });
    ...
    it('should display error message for invalid Work Contact Number', () => {
        ...
        document.getElementsByTagName('input')[8].click();
        const validationSummary = document.getElementById('validationSummary').getElementsByTagName('ul')[0].innerHTML;
        expect(validationSummary).contain(`Work Contact No should start with country code prefixed by + and followed by 10 digits`);
    });
    ...
    it('should display error message for length of notes greater than 200', () => {
        ...
        document.getElementsByTagName('input')[8].click();
        const validationSummary = document.getElementById('validationSummary').getElementsByTagName('ul')[0].innerHTML;
        expect(validationSummary).contain(`Notes should contain maximum of 200 characters`);
    });
    ...
    it('should not display any error message for valid inputs', () => {
        ...
        document.getElementsByTagName('input')[8].click();
        const validationSummary = document.getElementById('validationSummary').getElementsByTagName('ul')[0].innerHTML;
        expect(validationSummary).equal(``);
    });
