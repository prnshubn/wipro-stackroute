...
const showPersistedData = require('../js/contact_service');
const persistSubmittedContact = require('../js/contact_service');
const axios = require('axios');
const document=require('chai-dom');
...
describe("Contact Form", function () {
    ...
    it("should have persistSubmittedContact function", function () {
        expect(typeof (persistSubmittedContact)).equal("object");
    });

    it("should have showSubmittedContact function", function () {
        expect(typeof (showPersistedData)).equal("object");
    });
    ...
    it('should post details of given contacts', (done) => {
        ...
        contactService.persistSubmittedContact(() => {
            expect(
                document.getElementById("contact-list").getElementsByTagName('table')[0]
                .getElementsByTagName('tbody')[0].innerHTML).toContain("robert");
            });
            expect(axios.post).to;
            done();
    });
});
...
function uiDOM() {
    document.innerHTML = `<section class="container">
    <div class="row">
